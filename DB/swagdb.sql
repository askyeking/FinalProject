...
CREATE TABLE IF NOT EXISTS `vendor` (
  ...
  `image_url` VARCHAR(450) NULL DEFAULT 'https://feedingsouthflorida.org/wp-content/uploads/2015/09/image-pending.gif',
  `about` TEXT NULL,
...
CREATE TABLE IF NOT EXISTS `customer` (
  ...
  `user_id` INT NOT NULL,
  `display_name` VARCHAR(45) NOT NULL,
  `avatar_url` VARCHAR(450) NULL DEFAULT 'https://feedingsouthflorida.org/wp-content/uploads/2015/09/image-pending.gif',
  `active` TINYINT(1) NOT NULL DEFAULT 1,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `inventory_item` (
  ...
  `image_url` VARCHAR(450) DEFAULT 'https://feedingsouthflorida.org/wp-content/uploads/2015/09/image-pending.gif',
...
INSERT INTO `inventory_item` (`id`, `vendor_id`, `price`, `name`, `description`, `image_url`, `item_condition`, `active`, `rented`) VALUES (11, 4, 6.99, 'Kid\'s Ski Jacket', 'Kid\'s ski jacket to keep them warm on the slopes.', 'https://www.trespass.com/media/catalog/product/cache/6/small_image/420x/0dc2d03fe217f8c83829496872af24a0/c/r/crawley-ucsuskk20001-blr-a_4.jpg', 'New', 1, 1);

INSERT INTO `inventory_item` (`id`, `vendor_id`, `price`, `name`, `description`, `image_url`, `item_condition`, `active`, `rented`) VALUES (12, 4, 12.99, 'Women\'s Ski Suit', 'Women\'s ski suit with all the accessories.', 'https://www.ski-chic.com/media/catalog/product/cache/2/image/1800x/040ec09b1e35df139433887a97daa66f/v/1/v12.jpg', 'good', 1, 1);
